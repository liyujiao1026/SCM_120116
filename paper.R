...
###
range.1 <- list(c(1,10),c(11,30))
sapply( range.1, Write_SD_Data)

range.2 <- list(c(31,50), c(51,100))
sapply( range.2, Write_SD_Data)

range.3 <- list( c(101,150), c(151,200))  
sapply( range.3, Write_SD_Data)
...
range.4 <- list(c(201,230),c(231,250))
sapply( range.4, Write_SD_Data)

range.5 <- list(c(251,270), c(271,300))
sapply( range.5, Write_SD_Data)

range.6 <- list( c(301,330), c(330,384))  
sapply( range.6, Write_SD_Data)
